package com.aopApp.AopAppApplication.aspects;
...
//    @Before("execution(* com.codingshuttle.aopApp.services.impl.*.orderPackage(..))")
    @Before("execution(* com.aopApp.AopAppApplication.services.impl.*.*(..))")
    ...
    @Before("within(com.aopApp.AopAppApplication..*)")
    ...
    @Pointcut("@annotation(com.aopApp.AopAppApplication.aspects.MyLogging) && within(com.aopApp.AopAppApplication..*)")
